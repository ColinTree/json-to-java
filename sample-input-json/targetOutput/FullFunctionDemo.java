/**
 * ~INFO~: This java file is generated by json-to-java by ColinTree!
...
public final class FullFunctionDemo extends SuperClass implements Interface1, Interface2 {
	...
	public final static List<String> publicFinalStaticList = null;
	...
	enum EnumSample implements Interface1, Interface2 {
		A,
		B (arg1, arg2),
		C;
		EnumSample () {
		...
		private EnumSample (String arg1, int arg2) {
			// constructor with accessModifier & arguments
		}

	}
	enum EnumInObjectScheme {
		C1 {
			void abstractMethod () {
			}
		},
